...
public class ProfileFragment extends Fragment {
    ...
    LinearLayout lineNotify;
    LinearLayout linePolicy;
    LinearLayout lineLanguage;
    LinearLayout lineSecurity;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        lineCurrencyUnit = view.findViewById(R.id.line_currency_unit);
        ...
        lineLanguage = view.findViewById(R.id.line_language);
        ...
        lineNotify = view.findViewById(R.id.line_notification);
        lineNotify.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
        ...
        linePolicy = view.findViewById(R.id.line_policy);
        ...
        lineSecurity = view.findViewById(R.id.line_security);
        lineSecurity.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
